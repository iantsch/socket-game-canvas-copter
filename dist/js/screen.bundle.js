...
var Screen = function () {
    function Screen(options) {
        ...
        this._socket.emit('create-screen', this._options.screenId, function (data) {
            if (data.error) {
                if (_this._options.onError) {
                    _this._options.onError(data.error);
                }
                return;
            }

            // a new controller connected to this screen
            _this._socket.on('controller-connected', function (data) {
                _this._callbacks['controller-connected'].forEach(function (callback) {
                    return callback(data);
                });
            });

            // a controller disconnected from this screen
            _this._socket.on('controller-disconnected', function (data) {
                _this._callbacks['controller-disconnected'].forEach(function (callback) {
                    return callback(data);
                });
            });

            // controller wraps generic events into "controller-event"
            _this._socket.on('controller-event', function (eventWrapper, socketCallback) {
                ...
                _this._callbacks[event].forEach(function (callback) {
                    return callback(data, socketCallback);
                });
            });

            if (_this._options.onConnect) {
                _this._options.onConnect(data);
            }
        });
    }
...
exports.roundedRect = exports.raf = undefined;
...
var _PlayerManager = __webpack_require__(64);
...
var roundedRect = exports.roundedRect = function roundedRect(draw, x, y, width, height, radius) {
    draw.beginPath();
...
var Game = function () {
    function Game(canvasId, parentId, options) {
    ...
    _createClass(Game, [{
        key: "init",
        value: function init(canvasId, parentId, options) {
            ...
            this.playerManager = new _PlayerManager2.default(this.options, this.drawContext);
        ...
        value: function resetGameData() {
            ...
            this.playerManager.players.forEach(function (player) {
                player.y = Math.round(_this.options.canvas.height / 2);
                player.isAlive = true;
        ...
        value: function draw() {
            ...
            var alivePlayers = this.playerManager.getAlivePlayers();
            alivePlayers.forEach(function (playerID) {
                var copter = _this2.playerManager.getPlayerByID(playerID);
                copter.isAlive = !_this2.checkForImpact(copter);
                if (!copter.isAlive) {
                    _this2.callback.collision();
                }
            });
            ...
            if (alivePlayers.length > 0) {
                ...
                alivePlayers.forEach(function (playerID) {
                    var copter = _this2.playerManager.getPlayerByID(playerID);
                    copter.draw(_this2.gameData.delta.time * _this2.options.canvas.refreshRate);
                    copter.totalDistance++;
                    _this2.callback.tick(copter.ID);
                });
                this.createWalls();
        ...
        key: "checkForImpact",
        value: function checkForImpact(copter) {
            if (this.gameData.obstacles.current.length >= 1) {
                ...
                try {
                    for (var _iterator = this.gameData.obstacles.current[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        var obstacle = _step.value;

                        if (obstacle.x >= copter.x && obstacle.x <= copter.x + this.options.obstacles.width) {
                            if (copter.y >= obstacle.y && copter.y <= obstacle.y + this.options.obstacles.height) {
                                return true;
                            }
                        }
                    }
            ...
            try {
                for (var _iterator2 = this.gameData.walls.current[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var wall = _step2.value;

                    if (wall.x < this.options.walls.width + copter.width) {
                        if ((this.gameData.walls.current[0].width == this.options.canvas.width + this.options.walls.width || // first wall
        ...
        key: "createInitialWalls",
        value: function createInitialWalls() {
        ...
        value: function createWalls() {
            ...
            try {
                for (var _iterator3 = this.gameData.walls.current[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        ...
        value: function createObstacles() {
            ...
            if (this.gameData.obstacles.counter++ >= Math.floor(this.options.obstacles.separation / this.gameData.delta.x)) {
                if (this.gameData.walls.currentHeight <= this.options.walls.maxHeight && this.options.walls.heightIncreaseInterval > 0 && this.gameData.walls.heightIncreaseInterval++ == this.options.walls.heightIncreaseInterval) {
            ...
            try {
                for (var _iterator4 = this.gameData.obstacles.current[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        ...
        key: "handleControl",
        value: function handleControl(userId, direction) {
        ...
        key: "updateCanvas",
        value: function updateCanvas(settings) {
            this.options.canvas.width = this.canvas.width = settings.width;
            this.options.canvas.height = this.canvas.height = settings.height;
        }
    }, {
        key: "setRoundCallback",
        value: function setRoundCallback(callback) {
            this.setCallback(callback, 'round');
        }
    }, {
        key: "setCollisionCallback",
        value: function setCollisionCallback(callback) {
            this.setCallback(callback, 'collision');
        }
    }, {
        key: "setTickCallback",
        value: function setTickCallback(callback) {
            this.setCallback(callback, 'tick');
        }
    }, {
        key: "setCallback",
        value: function setCallback(callback, type) {
...
var _screen = __webpack_require__(59);

var _Screen = __webpack_require__(62);

var _Screen2 = _interopRequireDefault(_Screen);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var api = new _screen.GameScreen(function () {
    // TODO : use socket-games-api
    top.JSCONST.onGameCreated();
    var screen = new _Screen2.default(api);
    screen.run();
}, function (error) {
...
exports.GameScreen = exports.GameCenterScreen = undefined;

var _GameCenterScreen = __webpack_require__(60);

var _GameCenterScreen2 = _interopRequireDefault(_GameCenterScreen);

var _GameScreen = __webpack_require__(61);

var _GameScreen2 = _interopRequireDefault(_GameScreen);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.GameCenterScreen = _GameCenterScreen2.default;
exports.GameScreen = _GameScreen2.default;
...
var _Screen = __webpack_require__(48);
...
var GameCenterScreen = function () {
    function GameCenterScreen(_onConnect, onError) {
        var _this = this;

        _classCallCheck(this, GameCenterScreen);
        ...
        this._api = new _Screen2.default({
            url: null,
            screenId: this._screenId,
            onConnect: function onConnect(data) {
                _this._screenId = data.screenId;
                try {
                    localStorage.setItem('socket-games:screen-id', _this._screenId);
                } catch (e) {
        ...
        window.addEventListener('message', function (event) {
            ...
            if (event.data.key === 'socket-games:request-screen-id') {
                event.source.postMessage({
                    ...
                    url: location.origin,
                    screenId: _this._screenId
                }, event.origin);
            }
        });
    }

    _createClass(GameCenterScreen, [{
        key: 'on',
        value: function on() {
            var _api;

            (_api = this._api).on.apply(_api, arguments);
            return this;
        }
    }, {
        key: 'emit',
        value: function emit() {
            ...
            (_api2 = this._api).emit.apply(_api2, arguments);
            return this;
        }
    }]);

    return GameCenterScreen;
}();

exports.default = GameCenterScreen;
...
var GameScreen = function () {
    function GameScreen(onConnect, onError) {
        var _this = this;

        _classCallCheck(this, GameScreen);

        if (top === self) {
            throw 'Use GameCenterScreen for stand-alone.';
        }
        ...
        window.addEventListener('message', function (event) {
            ...
            if (event.data.key === 'socket-games:screen-id') {
                _this._setupApi(event.data.url, event.data.screenId, onConnect, onError);
            }
        });
        top.postMessage({
    ...
    _createClass(GameScreen, [{
        ...
        key: '_setupApi',
        value: function _setupApi(url, screenId, onConnect, onError) {
            this._api = new _Screen2.default({
                url: url,
...
var Screen = function () {
    ...
    _createClass(Screen, [{
        ...
        value: function run() {
            ...
            this.$.game = (0, _jquery2.default)('#game-container');
            this.$.scores = (0, _jquery2.default)('.scores');
            this._game = new _Game2.default('jsCopter', 'game-container', {
                canvas: {
            ...
            this._api.on('copter-exit', function () {
                ...
                setTimeout(function () {
                    _this2._api.emit('screen-exit');
                    top.JSCONST.stopGame();
                }, 10);
            });

            this._api.on('copter-up', function (data) {
                var playerId = Number(data.playerId);
                _this._game.handleControl(playerId, true);
            });

            this._api.on('copter-release', function (data) {
                var playerId = Number(data.playerId);
                _this._game.handleControl(playerId, false);
            });

            this._api.on('copter-refresh-color', function (data, callback) {
                var playerId = Number(data.playerId),
                    color = _this._game.playerManager.getColor();
                _this._game.playerManager.players[playerId].color = color;
                callback({
                    color: color
                });
                (0, _jquery2.default)('[data-playerId="' + playerId + '"] > span.playerColor').css('backgroundColor', color);
            });
        }
    }, {
        key: '_resizeCanvas',
        ...
        value: function _updateStats() {
            ...
            if (this._ranking.length > 1) {
                this._ranking.sort(function (controllerIdA, controllerIdB) {
                    if (_this3._players.hasOwnProperty(controllerIdA) && _this3._players.hasOwnProperty(controllerIdB) && _this3._players[controllerIdA].score > _this3._players[controllerIdB].score) {
                        return -1;
                    } else if (_this3._players.hasOwnProperty(controllerIdA) && _this3._players.hasOwnProperty(controllerIdB) && _this3._players[controllerIdA].score < _this3._players[controllerIdB].score) {
                        return 1;
                    } else {
                        return 0;
                    }
            ...
            try {
                for (var _iterator = this._ranking[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        key: '_onRoundCallback',
        value: function _onRoundCallback() {
            this._updateStats();
            (0, _jquery2.default)('.scores__item--is-dead').removeClass('scores__item--is-dead');
        }
    }, {
        key: '_onCollisionCallback',
        value: function _onCollisionCallback() {
            var _iteratorNormalCompletion2 = true;
            var _didIteratorError2 = false;
            var _iteratorError2 = undefined;
        ...
        key: '_onTick',
        value: function _onTick(playerId) {
        ...
        value: function renderScreenId() {
            ...
            new _qrcodejs2.default((0, _jquery2.default)('.qrcode')[0], url);
        }
    }]);
...
var _ColorManager = __webpack_require__(65);
...
var PlayerManager = function () {
    function PlayerManager(config, drawContext) {
        _classCallCheck(this, PlayerManager);

        this.config = config;
        this.drawContext = drawContext;
        this.players = [];
        this.colorManager = new _ColorManager2.default();
    }

    _createClass(PlayerManager, [{
        key: 'addPlayer',
        value: function addPlayer(name) {
            var newPlayer = new _Player2.default(this.drawContext);
        ...
        key: 'playerPush',
        value: function playerPush(newPlayer) {
            var i = 0;
            var _iteratorNormalCompletion = true;
            var _didIteratorError = false;
            var _iteratorError = undefined;
        ...
        key: 'navigatePlayer',
        value: function navigatePlayer(playerID, direction) {
        ...
        key: 'numberOfPlayersAlive',
        value: function numberOfPlayersAlive() {
            var count = 0;
        ...
        key: 'getPlayerName',
        value: function getPlayerName(playerID) {
            return this.players[playerID].name;
        }
    }, {
        key: 'getPlayerTotalDistance',
        value: function getPlayerTotalDistance(playerID) {
        ...
        key: 'getPlayerWins',
        value: function getPlayerWins(playerID) {
...
var ColorManager = function () {
    ...
    _createClass(ColorManager, [{
        ...
        key: 'convertRGBToHex',
        value: function convertRGBToHex(color) {
            var r = void 0,
                g = void 0,
                b = void 0;
        ...
        key: 'convertHSVToRGB',
        value: function convertHSVToRGB(hue, saturation, value) {
            var h = void 0,
                hi = void 0,
                f = void 0,
                p = void 0,
            ...
            return [Math.floor(rgbResult[0] * 255), Math.floor(rgbResult[1] * 255), Math.floor(rgbResult[2] * 255)];
        }
    }]);
...
var Player = function () {
    ...
    _createClass(Player, [{
        ...
        value: function draw(delta) {
            ...
            draw.beginPath();
            (0, _Game.roundedRect)(draw, 0, 0, this.width, this.height, 10);
