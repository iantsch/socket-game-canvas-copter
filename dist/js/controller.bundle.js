...
var Controller = function () {
    function Controller(options) {
        ...
        this._socket.emit('join-screen', this._options.screenId, function (data) {
            if (data.error) {
                if (_this._options.onError) {
            ...
            _this._socket.on('screen-disconnected', function (data) {
                if (data.screenId !== _this._options.screenId) {
                    return;
                }
                _this._callbacks['screen-disconnected'].forEach(function (callback) {
                    return callback(data);
                });
            });

            _this._socket.on('screen-event', function (eventWrapper, socketCallback) {
...
var api = new _controller.GameController(function () {
    var controller = new _Controller2.default(api);
    controller.run();
}, function (error) {
...
exports.GameController = exports.GameCenterController = undefined;

var _GameCenterController = __webpack_require__(53);

var _GameCenterController2 = _interopRequireDefault(_GameCenterController);

var _GameController = __webpack_require__(54);

var _GameController2 = _interopRequireDefault(_GameController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.GameCenterController = _GameCenterController2.default;
exports.GameController = _GameController2.default;
...
var GameCenterController = function () {
    function GameCenterController(onConnect, onError, screenId) {
        var _this = this;

        _classCallCheck(this, GameCenterController);

        if (top !== self) {
            throw 'Use GameController inside iframe for games.';
        }
        this._screenId = screenId;
        this._api = new _Controller2.default({
            url: null,
            screenId: screenId,
            onConnect: onConnect,
            onError: onError
    ...
    _createClass(GameCenterController, [{
        key: 'on',
        value: function on() {
            var _api;
...
exports.default = GameCenterController;
...
var GameController = function () {
    function GameController(onConnect, onError) {
        var _this = this;
    ...
    _createClass(Controller, [{
        ...
        value: function run() {
            ...
            this._api.emit('copter-player-join', {
                ...
                _this._player.color = data.color;
                ...
                _this._emitDirection();
            });

            (0, _jquery2.default)(top.document).on('keydown', function (event) {
                if (event.keyCode === 32) {
                    _this._emitUp();
                }
            });

            (0, _jquery2.default)(top.document).on('keyup', function (event) {
                if (event.keyCode === 32) {
                    _this._emitRelease();
                }
            });
            ...
            this.$.exit.on('mousedown touchstart', function (event) {
                _this.$.exit.addClass('pressed');
            }).on('mouseup touchend', function (event) {
                _this.$.exit.removeClass('pressed');
            }).on('click', function (event) {
                event.preventDefault();
                if (confirm('really?')) {
                    _this._api.emit('copter-exit', {});
                }
            });
            this.$.refreshColor.on('mousedown touchstart', function (event) {
                _this.$.refreshColor.addClass('pressed');
            }).on('mouseup touchend', function (event) {
                _this.$.refreshColor.removeClass('pressed');
            }).on('click', function (event) {
                event.preventDefault();
                _this._api.emit('copter-refresh-color', {
                    playerId: _this._player.id
                }, function (data) {
                    _this._player.color = data.color;
                    (0, _jquery2.default)('body').css({
                        borderColor: _this._player.color,
            ...
            this._api.on('screen-exit', function () {
                return top.JSCONST.stopGame();
            });

            this._api.on('copter-tick', function (data) {
                _this.$.totalDistance.empty().html(Math.floor(data.totalDistance / 10));
                _this.$.maxDistance.empty().html(Math.floor(data.maxDistance / 10));
            });
        }
    }, {
        key: '_emitUp',
        value: function _emitUp() {
            (0, _jquery2.default)('.move').addClass('pressed');
            this._goingUp = true;
            this._emitDirection();
        }
    }, {
        key: '_emitRelease',
        value: function _emitRelease() {
            (0, _jquery2.default)('.move').removeClass('pressed');
            this._goingUp = false;
            this._emitDirection();
        }
    }, {
        key: '_emitDirection',
        value: function _emitDirection() {
            var event = this._goingUp ? 'copter-up' : 'copter-release';
